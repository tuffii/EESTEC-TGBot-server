...
export interface Output {
  ...
  readonly [TableFields.achievement]: string;
}

export interface Input {
  readonly [TableFields.achievement]: Output[typeof TableFields.achievement]; // Декларация типа данных, которое содержит поле при ВВОДЕ со ссылкой на декларацию этого же поля для вывода.
